...
<script type="text/javascript">
	function checkWrite(){
		if(document.edu_write.school.value == ""){
			alert("'학교명'란을 채워주세요");
		}else if(document.edu_write.stat.value == ""){
			alert("'재학 상태'란을 채워주세요");
		}else if(document.edu_write.degree.value == ""){
			alert("'학위'란을 채워주세요");
		}else if(document.edu_write.major.value == ""){
			alert("'전공'란을 채워주세요");
		}else if(document.edu_write.gpa.value == ""){
			alert("'학점'란을 채워주세요");
		}else{
			document.edu_write.submit();
		}
	}
</script>
<style>
...
<hr>
<div align="center">
	<form action="${pageContext.request.contextPath }/profile/edu_write" method="post" name="edu_write">
		<table>														
			<tr>
				<th>학교명</th>
