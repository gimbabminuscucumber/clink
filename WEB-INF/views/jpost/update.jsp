...
function checkWrite(){
	if(document.jpost_update.title.value == ""){
		alert("'채용공고 제목'란을 채워주세요");
		<!-- date 타입은 어떻게 체크하는지?? -->
	}else if(document.jpost_update.howto.value == ""){
		alert("'링크'란을 채워주세요");
	}else if(document.jpost_update.jarea_cno.value == 0){
		alert("'고용 직군'란을 채워주세요");
	}else if(document.jpost_update.worktime_cno.value == 0){
		alert("'근무 시간'란을 채워주세요");
	}else if(document.jpost_update.empl_type_cno.value == 0){
		alert("'고용 형태'란을 채워주세요");
	}else if(document.jpost_update.posi_cno.value == 0){
		alert("'고용 직급'란을 채워주세요");
	}else if(document.jpost_update.lv_cno.value == 0){
		alert("'경력'란을 채워주세요");
	}else if(document.jpost_update.school_cno.value == 0){
		alert("'교육'란을 채워주세요");
	}else if(document.jpost_update.type.value == ""){
		alert("'근무 형태'란을 채워주세요");
	}else if(document.jpost_update.task.value == ""){
		alert("'모집 주요 업무'란을 채워주세요");
	}else if(document.jpost_update.salary.value == ""){
		alert("'연봉'란을 채워주세요");
	}else if(document.jpost_update.locate.value == ""){
		alert("'근무지'란을 채워주세요");
	}else if(document.jpost_update.detail.value == ""){
		alert("'상세 내용'란을 채워주세요");
	}else{
		document.jpost_update.submit();
	}
}
							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="editing-info">
										<h5 class="f-title"><i class="ti-info-alt"></i> 채용공고 수정</h5>
										<form action="${pageContext.request.contextPath }/jpost/update" method="post" name="jpost_update">
										<input type="hidden" value="${vo.JPOST_ID }" name="jpost_id">
											<div class="form-group">	
												<input type="text" name="title" required="required" value="${vo.TITLE }"/>
...
<!-- 											<input type="text" id="input" required="required"/> -->
											...
											<div class="form-group" id="imUrl" style="display: none">	 
											  	<input type="url" name="url" value="${vo.URL }">
											  	<label class="control-label" for="input">링크</label><i class="mtrl-select"></i>
											</div>
											...
											<div class="form-group">	
											  	<input type="text" name="task" required="required" value="${vo.TASK }"/>
											  	<label class="control-label" for="input">주요 업무</label><i class="mtrl-select"></i>
											</div>
											<div class="form-group">	
											  	<input type="text" name="salary" required="required" value="${vo.SALARY }"/>
											  	<label class="control-label" for="input">연봉</label><i class="mtrl-select"></i>
											</div>
											<div class="form-group">	
												<input type="text" name="locate" required="required" value="${vo.LOCATE }"/>
