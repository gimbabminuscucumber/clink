...
<div align="center">
	<form action="${pageContext.request.contextPath }/profile/vol_write" method="post" name="write">
		<table>			
			<tr>
				<th>단체명</th>
				<tr><td><input type="text" name="org" placeholder="ex) "></td>
			</tr>
			<tr>
				<th>활동 내용</th>
				<tr><td><input type="text" name="content" placeholder="ex) "></td>
			</tr>
			<tr>
				<th>현재 활동 여부</th>
				<tr>
			...
			<tr>
				<th>설명</th>
				<tr><td><textarea rows="15" cols="65" name="detail" placeholder="ex) 반려동물에 대한 관심이 많아 OO기관을 통해 유기견 센터에서 OO활동을 했습니다."></textarea></td>
			</tr>
		</table>	
	</form>
	<div class="btn">
